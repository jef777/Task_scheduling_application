...
return (
    <>
      <div className="relative bg-white">
        ...
        <div
          className={ open
              ? "opacity-100 transition scale-100 ease-out duration-200 absolute top-0 inset-x-0 p-2 origin-top-right md:hidden"
              : "opacity-0 scale-95 absolute top-0 inset-x-0 p-2 transition origin-top-right md:hidden"
          }
        >
